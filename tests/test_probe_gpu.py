...
def test_get_nv_gpu_info_success(mock_subprocess_run):
    ...
    mock_subprocess_run.return_value.stdout = b"Tesla K80, 50, 1024, 4096, 70, 100, 150, 875, 875, 875, 875, 2505, 2505\n"
    
    result = get_nv_gpu_info()
    
    expected_result = [
        "Tesla K80", 50.0, 1024.0, 4096.0, 70.0, 100.0, 150.0, 875.0, 875.0, 875.0, 875.0, 2505.0, 2505.0
    ]
